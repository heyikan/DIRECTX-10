...
private:
	...
	ID3D10EffectTechnique*		g_pBasicTechniqueLight;
	...
	ID3D10EffectMatrixVariable* g_pWorldInverseTransposeVariable;

	ID3D10EffectVectorVariable* g_pLightPosVariable;
...
private:
	...
	HRESULT load3DMaxMesh(std::wstring filename);
